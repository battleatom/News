...
export class Store{
  ...
  setFeed(feed){this.feed=feed;if(!feed?.categories?.[this.active]&&this.active!=="bookmarks"){this.active=Object.keys(feed?.categories||{})[0]||"top";writeActiveTab(this.active)}}
  setActive(category){if(category==="bookmarks"||this.feed?.categories?.[category]){this.active=category;writeActiveTab(category)}if(!this.visible.has(category))this.visible.set(category,PAGE_SIZE)}
