...
REQUIRED_NONEMPTY={"top","nfl","underreported","world","us","presidential","federal","legislation","nm","local","region","technology","gaming","military","entertainment"};MIN_TOTAL=120;MAX_ERROR_RATIO=0.35;MIN_POSTER_COVERAGE=0.95
