...
STYLE='''<style id="nfl-live-style">.nfl-live-note{padding:7px 10px;margin-bottom:8px;border:1px solid var(--ui-line);border-radius:9px;background:rgba(255,255,255,.68);font-size:10px;line-height:1.3;color:#64748b}.nfl-live-note strong{color:#166534}.nfl-game-card{padding:10px 12px!important;min-height:0!important;margin:7px 0!important}.nfl-score-line{display:flex;align-items:center;gap:8px;min-width:0;flex-wrap:wrap;font-size:15px!important;line-height:1.35!important;color:#334155}.nfl-score-line .teams{font-size:16px!important;font-weight:850;color:#0f172a}.nfl-score-line .status{font-size:12px!important;color:#64748b}.nfl-score-line .tv{margin-left:auto;overflow:hidden;text-overflow:ellipsis;color:#475569;font-size:11px}.nfl-score-line a{font-size:11px}.nfl-live-dot{display:inline-block;width:7px;height:7px;border-radius:50%;background:#16a34a;margin-right:5px;box-shadow:0 0 0 2px rgba(22,163,74,.12)}@media(max-width:600px){.nfl-live-note{font-size:10px;padding:7px 9px}.nfl-game-card{padding:11px 10px!important;margin:8px 0!important}.nfl-score-line{gap:6px;font-size:14px!important;line-height:1.4!important}.nfl-score-line .teams{font-size:15px!important;flex:1 1 100%}.nfl-score-line .status{font-size:11px!important}.nfl-score-line .tv{font-size:10px;margin-left:0;flex:1 1 100%;white-space:normal}.nfl-score-line a{font-size:10px}}</style>'''
...
print('Added readable live NFL scoreboard through the canonical render router.')
