...
/* Article hierarchy: consistent sizing, with restrained color rails. */
.news-item,
.news-item:first-child{
  ...
  border-left:3px solid var(--ui-purple)!important;
...
print('Applied theme-aligned article typography.')
