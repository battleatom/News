...
"gaming":TabRule(D(video_game=13,gaming=11,playstation=12,xbox=12,nintendo=12,steam=9,game_studio=10,game_developer=10,game_development=9,console=8,pc_gaming=11,pc_gamer=10,esports=10,gameplay=8,dlc=7,game_release=9),D(casino=-20,gambling=-20,sportsbook=-20,lottery=-18,slot_machine=-18),9,11),
