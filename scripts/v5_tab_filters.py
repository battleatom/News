...
def tab_filter_decision(i):
    ...
    # Underreported is editorially curated upstream. The fresh stack only removes obvious noise;
    # it must not strip a consequential story merely because it lacks a keyword in the headline.
