...
"military":TabRule(D(pentagon=14,armed_forces=13,troops=11,air_force=11,u_s_army=12,u_s_navy=12,army=7,navy=7,marines=11,military=8,defense=6,defense_budget=10,defense_chief=10,missile=10,airstrike=12,air_strike=12,drone_strike=12,drone_warfare=10,warfare=8,warship=11,combat=10,battlefield=11,invasion=11,ceasefire=9,defense_department=14,centcom=14,military_operation=13,military_strike=13,military_deployment=12,military_aircraft=11,military_equipment=11,munition=10,munitions=10,weapon_system=10,fighter_jet=10,warfighter=9,warfighters=9),D(border_war=-24,war_on_drugs=-22,price_war=-22,trade_war=-20,culture_war=-20,war_against=-18,veterans_museum=-18,veterans_day=-16,military_veteran=-10,war_memorial=-16,defense_attorney=-20,defense_lawyer=-20,team_defense=-14),10,11),
"presidential":TabRule(D(president_trump=14,donald_trump=11,trump_administration=14,trump=5.5,white_house=13,executive_order=13,oval_office=12,press_secretary=10,presidential=9,commander_in_chief=10,administration_policy=8),D(former_president=-7,company_president=-20,university_president=-20,team_president=-20),10,10),
...
def obvious_noise(i):
    ...
    return any(x in t for x in [" obituary "," winning numbers "," lottery "," things to do "," classifieds "," job postings "," horoscope "," recipe "," prep roundup "," latest defense news weekly videos "," latest - defense news "," author "," current & breaking news "," odds, picks and predictions ",".jpg "])
